    ...
    constructor() {
        async function getData() {
            ...
            const cleaned = carsData.map((car: { Miles_per_Gallon: any; Horsepower: any; }) => ({
                ...
                .filter((car: { mpg: any; horsepower: any; }) => (car.mpg != null && car.horsepower != null));
        ...
        function testModel(model: { predict: (arg0: any) => any; }, inputData: any[], normalizationData: { inputMax: any; inputMin: any; labelMin: any; labelMax: any; }) {
